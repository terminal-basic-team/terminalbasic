...
#define HAL_ARDUINO_TERMINAL_SERIALLIGHT 2

#define HAL_ARDUINO_TERMINAL HAL_ARDUINO_TERMINAL_SERIALLIGHT

#if (HAL_ARDUINO_TERMINAL == HAL_ARDUINO_TERMINAL_SERIAL) || \
    (HAL_ARDUINO_TERMINAL == HAL_ARDUINO_TERMINAL_SERIALLIGHT)
