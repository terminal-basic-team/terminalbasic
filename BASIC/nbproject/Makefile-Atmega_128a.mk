...
${OBJECTDIR}/include/basic_arduinoio.o: include/basic_arduinoio.cpp nbproject/Makefile-${CND_CONF}.mk
	...
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -DARDUINO=10607 -DARDUINO_ARCH_AVR -DARDUINO_AVR_UNO -DF_CPU=8000000L -I${ARDUINO_PATH}/hardware/arduino/avr/cores/arduino -I${ARDUINO_PATH}/hardware/arduino/avr/libraries/SoftwareSerial/src -Iinclude -I../arduinoext/include -I/opt/arduino-1.6.12/hardware/arduino/avr/libraries/EEPROM/src -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/atmega64_128 -include Arduino.h -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/basic_arduinoio.o include/basic_arduinoio.cpp
