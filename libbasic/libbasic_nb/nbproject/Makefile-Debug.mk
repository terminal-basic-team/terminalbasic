...
${OBJECTDIR}/_ext/511e4115/basic.o: ../src/basic.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../include -I../../../libarduinoemulator/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/basic.o ../src/basic.c
...
${OBJECTDIR}/_ext/511e4115/basic_lexer_eng.o: ../src/basic_lexer_eng.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../include -I../../../libarduinoemulator/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/basic_lexer_eng.o ../src/basic_lexer_eng.c

${OBJECTDIR}/_ext/511e4115/basic_lexer_ru.o: ../src/basic_lexer_ru.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../include -I../../../libarduinoemulator/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/basic_lexer_ru.o ../src/basic_lexer_ru.c
...
${OBJECTDIR}/_ext/511e4115/tools.o: ../src/tools.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../include -I../../../libarduinoemulator/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/tools.o ../src/tools.c
