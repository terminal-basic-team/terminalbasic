...
${OBJECTDIR}/include/bytearray.o: include/bytearray.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_UNO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/bytearray.o include/bytearray.cpp
