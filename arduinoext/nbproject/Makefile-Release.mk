...
${OBJECTDIR}/include/math.o: include/math.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/math.o include/math.cpp

${OBJECTDIR}/src/bytearray.o: src/bytearray.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bytearray.o src/bytearray.cpp
...
${OBJECTDIR}/src/extmemtest.o: src/extmemtest.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/extmemtest.o src/extmemtest.cpp
...
${OBJECTDIR}/include/math_nomain.o: ${OBJECTDIR}/include/math.o include/math.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/math_nomain.o include/math.cpp;\
	else  \
...
${OBJECTDIR}/src/bytearray_nomain.o: ${OBJECTDIR}/src/bytearray.o src/bytearray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bytearray_nomain.o src/bytearray.cpp;\
	else  \
...
${OBJECTDIR}/src/extmemtest_nomain.o: ${OBJECTDIR}/src/extmemtest.o src/extmemtest.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -Wall -Iinclude -I../libarduinoemulator/include -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/extmemtest_nomain.o src/extmemtest.cpp;\
	else  \
