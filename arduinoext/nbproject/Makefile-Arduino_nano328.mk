...
${OBJECTDIR}/_ext/38f13fd/arduino_logger.o: ../arduinoext/src/arduino_logger.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/38f13fd/arduino_logger.o ../arduinoext/src/arduino_logger.cpp

${OBJECTDIR}/include/bcopy.o: include/bcopy.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/bcopy.o include/bcopy.cpp

${OBJECTDIR}/src/cps_mosprotocol.o: src/cps_mosprotocol.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cps_mosprotocol.o src/cps_mosprotocol.cpp
...
${OBJECTDIR}/src/protocol.o: src/protocol.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/protocol.o src/protocol.cpp

${OBJECTDIR}/src/protocol_arduino.o: src/protocol_arduino.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/protocol_arduino.o src/protocol_arduino.cpp
...
${TESTDIR}/tests/newsimpletest.o: tests/newsimpletest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_NANO -DF_CPU=16000000L -Iinclude -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest.o tests/newsimpletest.cpp
