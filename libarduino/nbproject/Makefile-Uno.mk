...
${OBJECTDIR}/_ext/58edad8c/DefaultFonts.o: /opt/arduino-1.6.12/libraries/UTFT/DefaultFonts.c nbproject/Makefile-${CND_CONF}.mk
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_MEGA2560 -DF_CPU=16000000L -I${ARDUINO_PATH}/hardware/arduino/avr/cores/arduino -I${ARDUINO_PATH}/hardware/arduino/avr/variants/eightanaloginputs -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/58edad8c/DefaultFonts.o /opt/arduino-1.6.12/libraries/UTFT/DefaultFonts.c

${OBJECTDIR}/_ext/58edad8c/UTFT.o: /opt/arduino-1.6.12/libraries/UTFT/UTFT.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/_ext/58edad8c
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DARDUINO=10612 -DARDUINO_ARCH_AVR -DARDUINO_AVR_UNO -DF_CPU=16000000L -I/opt/arduino-1.6.12/hardware/arduino/avr/cores/arduino -I/opt/arduino-1.6.12/hardware/arduino/avr/variants/eightanaloginputs -I/opt/arduino-1.6.12/hardware/arduino/avr/libraries/SoftwareSerial/src -I/opt/arduino-1.6.12/libraries/SD/src -I/opt/arduino-1.6.12/hardware/arduino/avr/libraries/SPI/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/58edad8c/UTFT.o /opt/arduino-1.6.12/libraries/UTFT/UTFT.cpp
