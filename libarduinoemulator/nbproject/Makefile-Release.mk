...
${OBJECTDIR}/include/Print.o: include/Print.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Print.o include/Print.cpp

${OBJECTDIR}/include/Stream.o: include/Stream.cpp
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Stream.o include/Stream.cpp

${OBJECTDIR}/src/arduino.o: src/arduino.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/arduino.o src/arduino.cpp
